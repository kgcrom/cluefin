...
from cluefin_openapi_cli.handlers.kiwoom import domestic_chart as handlers
...
def test_register_kiwoom_chart_handlers() -> None:
    assert_registers_all(handlers.register_kiwoom_chart_handlers, handlers._ALL_HANDLERS, "kiwoom")
