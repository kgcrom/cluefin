...
from cluefin_openapi_cli.handlers.kis import domestic_ranking_analysis as handlers
...
def test_register_kis_ranking_handlers() -> None:
    assert_registers_all(handlers.register_kis_ranking_handlers, handlers._ALL_HANDLERS, "kis")
