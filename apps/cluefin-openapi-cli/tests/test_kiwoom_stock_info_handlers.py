...
from cluefin_openapi_cli.handlers.kiwoom import domestic_stock_info as handlers
...
def test_register_kiwoom_stock_info_handlers() -> None:
    assert_registers_all(handlers.register_kiwoom_stock_info_handlers, handlers._ALL_HANDLERS, "kiwoom")
