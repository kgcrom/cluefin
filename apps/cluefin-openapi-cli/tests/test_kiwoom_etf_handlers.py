...
from cluefin_openapi_cli.handlers.kiwoom import domestic_etf as handlers
...
def test_register_kiwoom_etf_handlers() -> None:
    assert_registers_all(handlers.register_kiwoom_etf_handlers, handlers._ALL_HANDLERS, "kiwoom")
