    ...
    parameters={
        ...
        "properties": {
            ...
            "sort_by": {
                "type": "string",
                "enum": ["0", "1", "2", "3", "4"],
                "description": "0:avg-volume, 1:volume-increase-rate, 2:avg-turnover-rate, 3:trade-amount, 4:avg-trade-amount-turnover",
            },
            "price_min": {"type": "string", "description": "Min price filter (empty:all)"},
            "price_max": {"type": "string", "description": "Max price filter (empty:all)"},
            "volume_min": {"type": "string", "description": "Min volume filter (empty:all)"},
            "target_cls": {
                "type": "string",
                "description": "Target inclusion flags, 9-digit 0/1 string "
                "(margin 30/40/50/60/100%, credit 30/40/50/60%). Default 111111111 (all).",
            },
            "target_exclude_cls": {
                "type": "string",
                "description": "Target exclusion flags, 10-digit 0/1 string (invest-risk, caution, "
                "warning, short-overheat, halted, preferred, suspended, ETF, ETN, credit-order-blocked). "
                "Default 0000000000 (exclude none).",
            },
        },
        "required": ["market"],
    },
...
@rpc_method(
    ...
    parameters={
        ...
        "properties": {
            ...
            "price_max": {"type": "string", "description": "Max price filter (empty:all)"},
            "volume_min": {"type": "string", "description": "Min volume filter (empty:all)"},
            "target_cls": {"type": "string", "description": "Target inclusion code (0:all). Default 0."},
            "target_exclude_cls": {"type": "string", "description": "Target exclusion code (0:all). Default 0."},
        },
        "required": ["market"],
    },
    returns={"type": "object"},
...
@rpc_method(
    ...
    parameters={
        ...
        "properties": {
            ...
            "target_cls": {"type": "string", "description": "Target inclusion code (0:all). Default 0."},
            "target_exclude_cls": {"type": "string", "description": "Target exclusion code (0:all). Default 0."},
            "belong_cls": {"type": "string", "description": "Belong class code (0). Default 0."},
        },
...
@rpc_method(
    ...
    parameters={
        ...
        "properties": {
            ...
            "trade_amount_min": {
                "type": "string",
                "description": "Min trade amount filter in KRW thousands (empty:all)",
            },
            "belong_cls": {"type": "string", "description": "Belong class code (0). Default 0."},
        },
        "required": ["market", "sort_by"],
...
@rpc_method(
    ...
    parameters={
        ...
        "properties": {
            ...
            "price_min": {"type": "string", "description": "Min price filter (empty:all)"},
            "price_max": {"type": "string", "description": "Max price filter (empty:all)"},
            "volume_min": {"type": "string", "description": "Min volume filter (0:all, 100:100+ shares). Default 0."},
            "target_cls": {"type": "string", "description": "Target inclusion code (0:all). Default 0."},
            "target_exclude_cls": {"type": "string", "description": "Target exclusion code (0:all). Default 0."},
        },
...
@rpc_method(
    ...
    parameters={
        ...
        "properties": {
            ...
            "price_max": {"type": "string", "description": "Max price filter (empty:all)"},
            "volume_min": {"type": "string", "description": "Min volume filter (empty:all)"},
            "target_cls": {"type": "string", "description": "Target inclusion code (empty). Default empty."},
            "target_exclude_cls": {"type": "string", "description": "Target exclusion code (empty). Default empty."},
        },
...
def register_kis_ranking_handlers(dispatcher: DispatcherProtocol) -> None:
