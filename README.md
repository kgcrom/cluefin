...
한국 금융 투자 분석 툴킷. KIS/키움/NH PLUG/DART API 클라이언트, 기술적 분석, ML 예측을 제공합니다.
...
| 패키지 | 설명 |
|--------|------|
| [cluefin-openapi](packages/cluefin-openapi/) | KIS/키움/NH PLUG/DART Python API 클라이언트 (Pydantic, 속도 제한, 인증, 웹소켓) |
