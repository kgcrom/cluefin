...
class Client(BaseHttpClient):
    ...
    @property
    def periodic_report_financial_statement(self):
        from ._periodic_report_financial_statement import PeriodicReportFinancialStatement

        return PeriodicReportFinancialStatement(self)
