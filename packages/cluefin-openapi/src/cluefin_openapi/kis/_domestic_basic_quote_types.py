...
class DomesticStockCurrentPriceItem(BaseModel):
    ...
    marg_rate: str = Field(title="증거금 비율")
    rprs_mrkt_kor_name: str = Field(title="대표 시장 한글명")
    new_hgpr_lwpr_cls_code: Optional[str] = Field(default=None, title="신 고가 저가 구분 코드")
    bstp_kor_isnm: str = Field(title="업종 한글 종목명")
    temp_stop_yn: str = Field(title="임시 정지 여부")
    oprc_rang_cont_yn: str = Field(title="시가 범위 연장 여부")
    ...
    prdy_vrss_vol_rate: str = Field(title="전일 대비 거래량 비율")
    ...
    hts_frgn_ehrt: str = Field(title="HTS 외국인 소진율")
    frgn_ntby_qty: str = Field(title="외국인 순매수 수량")
    pgtr_ntby_qty: str = Field(title="프로그램매매 순매수 수량")
    pvt_scnd_dmrs_prc: str = Field(title="피벗 2차 디저항 가격")
    pvt_frst_dmrs_prc: str = Field(title="피벗 1차 디저항 가격")
    pvt_pont_val: str = Field(title="피벗 포인트 값")
    pvt_frst_dmsp_prc: str = Field(title="피벗 1차 디지지 가격")
    pvt_scnd_dmsp_prc: str = Field(title="피벗 2차 디지지 가격")
    dmrs_val: str = Field(title="디저항 값")
    dmsp_val: str = Field(title="디지지 값")
    cpfn: str = Field(title="자본금")
    rstc_wdth_prc: str = Field(title="제한 폭 가격")
    stck_fcam: str = Field(title="주식 액면가")
    stck_sspr: str = Field(title="주식 대용가")
    aspr_unit: str = Field(title="호가단위")
    hts_deal_qty_unit_val: str = Field(title="HTS 매매 수량 단위 값")
    lstn_stcn: str = Field(title="상장 주수")
    hts_avls: str = Field(title="HTS 시가총액")
    ...
    d250_hgpr: str = Field(title="250일 최고가")
    d250_hgpr_date: str = Field(title="250일 최고가 일자")
    d250_hgpr_vrss_prpr_rate: str = Field(title="250일 최고가 대비 현재가 비율")
    d250_lwpr: str = Field(title="250일 최저가")
    d250_lwpr_date: str = Field(title="250일 최저가 일자")
    d250_lwpr_vrss_prpr_rate: str = Field(title="250일 최저가 대비 현재가 비율")
    stck_dryy_hgpr: str = Field(title="주식 연중 최고가")
    dryy_hgpr_vrss_prpr_rate: str = Field(title="연중 최고가 대비 현재가 비율")
    dryy_hgpr_date: str = Field(title="연중 최고가 일자")
    stck_dryy_lwpr: str = Field(title="주식 연중 최저가")
    dryy_lwpr_vrss_prpr_rate: str = Field(title="연중 최저가 대비 현재가 비율")
    dryy_lwpr_date: str = Field(title="연중 최저가 일자")
    w52_hgpr: str = Field(title="52주일 최고가")
    w52_hgpr_vrss_prpr_ctrt: str = Field(title="52주일 최고가 대비 현재가 대비")
    w52_hgpr_date: str = Field(title="52주일 최고가 일자")
    w52_lwpr: str = Field(title="52주일 최저가")
    w52_lwpr_vrss_prpr_ctrt: str = Field(title="52주일 최저가 대비 현재가 대비")
    ...
    last_ssts_cntg_qty: str = Field(title="최종 공매도 체결 수량")
    invt_caful_yn: str = Field(title="투자유의여부")
    mrkt_warn_cls_code: str = Field(title="시장경고코드")
    short_over_yn: str = Field(title="단기과열여부")
    sltr_yn: str = Field(title="정리매매여부")
    mang_issu_cls_code: str = Field(title="관리종목여부")
...
class DomesticStockCurrentPriceItem2(BaseModel):
    rprs_mrkt_kor_name: str = Field(title="대표 시장 한글명")
    new_hgpr_lwpr_cls_code: Optional[str] = Field(default=None, title="신 고가 저가 구분 코드")
    mxpr_llam_cls_code: Optional[str] = Field(default=None, title="상한하한가 구분코드")
    crdt_able_yn: str = Field(title="신용 가능 여부")
    stck_mxpr: str = Field(title="주식 상한가")
    elw_pblc_yn: str = Field(title="ELW 발행 여부")
    prdy_clpr_vrss_oprc_rate: str = Field(title="전일 종가 대비 시가2 비율")
    crdt_rate: str = Field(title="신용 비율")
    marg_rate: str = Field(title="증거금 비율")
    lwpr_vrss_prpr: str = Field(title="최저가 대비 현재가")
    lwpr_vrss_prpr_sign: str = Field(title="최저가 대비 현재가 부호")
    prdy_clpr_vrss_lwpr_rate: str = Field(title="전일 종가 대비 최저가 비율")
    stck_lwpr: str = Field(title="주식 최저가")
    hgpr_vrss_prpr: str = Field(title="최고가 대비 현재가")
    hgpr_vrss_prpr_sign: str = Field(title="최고가 대비 현재가 부호")
    prdy_clpr_vrss_hgpr_rate: str = Field(title="전일 종가 대비 최고가 비율")
    stck_hgpr: str = Field(title="주식 최고가")
    oprc_vrss_prpr: str = Field(title="시가2 대비 현재가")
    oprc_vrss_prpr_sign: str = Field(title="시가2 대비 현재가 부호")
    mang_issu_yn: str = Field(title="관리 종목 여부")
    divi_app_cls_code: str = Field(title="등시호가배분적용구분코드")
    short_over_yn: str = Field(title="단기과열여부")
    mrkt_warn_cls_code: str = Field(title="시장 경고 구분")
    invt_caful_yn: str = Field(title="투자유의여부")
    stange_runup_yn: str = Field(title="이상급등여부")
    ssts_hot_yn: str = Field(title="공매도과열 여부")
    low_current_yn: str = Field(title="저유동성 중복여부")
    vi_cls_code: str = Field(title="VI적용구분코드")
    short_over_cls_code: str = Field(title="단기과열구분코드")
    stck_llam: str = Field(title="주식 하한가")
    new_lstn_cls_name: str = Field(title="신규 상장 구분명")
    vlnt_deal_cls_name: str = Field(title="임의 매매 구분명")
    flng_cls_name: Optional[str] = Field(default=None, title="락 구분 이름")
    revl_issu_reas_name: Optional[str] = Field(default=None, title="재평가 종목 사유 명")
    mrkt_warn_cls_name: Optional[Literal["투자환기", "투자경고"]] = Field(default=None, title="시장 경고 구분명")
    stck_sdpr: str = Field(title="주식 기준가")
    bstp_cls_code: str = Field(title="업종 구분 코드")
    stck_prdy_clpr: str = Field(title="주식 전일 종가")
    insn_pbnt_yn: str = Field(title="불성실 공시 여부")
    fcam_mod_cls_name: Optional[str] = Field(default=None, title="액면가 변경 구분 명")
    stck_prpr: str = Field(title="주식 현재가")
    prdy_vrss: str = Field(title="전일 대비")
    prdy_vrss_sign: str = Field(title="전일 대비 부호")
    prdy_ctrt: str = Field(title="전일 대비율")
    ...
    prdy_vrss_vol_rate: str = Field(title="전일 대비 거래량 비율")
    bstp_kor_isnm: str = Field(title="업종 한글 종목명")
    sltr_yn: str = Field(title="정리매매 여부")
    trht_yn: str = Field(title="거래정지 여부")
    oprc_rang_cont_yn: str = Field(title="시가 범위 연장 여부")
    vlnt_fin_cls_code: str = Field(title="임의 종료 구분 코드")
    stck_oprc: str = Field(title="주식 시가2")
...
class DomesticStockCurrentPriceDailyItem(BaseModel):
    ...
    hts_frgn_ehrt: str = Field(title="HTS 외국인 소진율")
    frgn_ntby_qty: str = Field(title="외국인 순매수 수량")
    flng_cls_code: str = Field(title="락 구분 코드")
    acml_prtt_rate: str = Field(title="누적 분할 비율")
...
class DomesticStockCurrentPriceAskingExpectedConclusionItem1(BaseModel):
    ...
    askp_rsqn_icdc1: str = Field(title="매도호가 잔량 증감1")
    askp_rsqn_icdc2: str = Field(title="매도호가 잔량 증감2")
    askp_rsqn_icdc3: str = Field(title="매도호가 잔량 증감3")
    askp_rsqn_icdc4: str = Field(title="매도호가 잔량 증감4")
    askp_rsqn_icdc5: str = Field(title="매도호가 잔량 증감5")
    askp_rsqn_icdc6: str = Field(title="매도호가 잔량 증감6")
    askp_rsqn_icdc7: str = Field(title="매도호가 잔량 증감7")
    askp_rsqn_icdc8: str = Field(title="매도호가 잔량 증감8")
    askp_rsqn_icdc9: str = Field(title="매도호가 잔량 증감9")
    askp_rsqn_icdc10: str = Field(title="매도호가 잔량 증감10")
    bidp_rsqn_icdc1: str = Field(title="매수호가 잔량 증감1")
    bidp_rsqn_icdc2: str = Field(title="매수호가 잔량 증감2")
    bidp_rsqn_icdc3: str = Field(title="매수호가 잔량 증감3")
    bidp_rsqn_icdc4: str = Field(title="매수호가 잔량 증감4")
    bidp_rsqn_icdc5: str = Field(title="매수호가 잔량 증감5")
    bidp_rsqn_icdc6: str = Field(title="매수호가 잔량 증감6")
    bidp_rsqn_icdc7: str = Field(title="매수호가 잔량 증감7")
    bidp_rsqn_icdc8: str = Field(title="매수호가 잔량 증감8")
    bidp_rsqn_icdc9: str = Field(title="매수호가 잔량 증감9")
    bidp_rsqn_icdc10: str = Field(title="매수호가 잔량 증감10")
...
class DomesticStockCurrentPriceAskingExpectedConclusionItem2(BaseModel):
    antc_mkop_cls_code: str = Field(title="예상 장운영 구분 코드")
    stck_prpr: str = Field(title="주식 현재가")
    stck_oprc: str = Field(title="주식 시가2")
    stck_hgpr: str = Field(title="주식 최고가")
    stck_lwpr: str = Field(title="주식 최저가")
...
class DomesticStockPeriodQuoteItem1(BaseModel):
    ...
    stck_hgpr: str = Field(title="주식 최고가")
    stck_lwpr: str = Field(title="주식 최저가")
    stck_prdy_oprc: str = Field(title="주식 전일 시가")
    stck_prdy_hgpr: str = Field(title="주식 전일 최고가")
    stck_prdy_lwpr: str = Field(title="주식 전일 최저가")
    askp: str = Field(title="매도호가")
    bidp: str = Field(title="매수호가")
    prdy_vrss_vol: str = Field(title="전일 대비 거래량")
    vol_tnrt: str = Field(title="거래량 회전율")
    stck_fcam: str = Field(title="주식 액면가")
    lstn_stcn: str = Field(title="상장 주수")
    cpfn: str = Field(title="자본금")
...
class DomesticStockPeriodQuoteItem2(BaseModel):
    ...
    prtt_rate: str = Field(title="분할 비율", description="기준가/전일 종가")
    mod_yn: str = Field(title="변경 여부")
    prdy_vrss_sign: str = Field(title="전일 대비 부호")
    prdy_vrss: str = Field(title="전일 대비")
...
class DomesticStockTodayMinuteChartItem1(BaseModel):
    ...
    prdy_vrss_sign: str = Field(title="전일 대비 부호")
    prdy_ctrt: str = Field(title="전일 대비율")
    stck_prdy_clpr: str = Field(title="전일대비 종가")
    acml_vol: str = Field(title="누적 거래량")
    acml_tr_pbmn: str = Field(title="누적 거래대금")
    hts_kor_isnm: str = Field(title="한글 종목명")
    stck_prpr: str = Field(title="주식 현재가")


class DomesticStockTodayMinuteChartItem2(BaseModel):
    stck_bsop_date: str = Field(title="주식 영업일자")
    stck_cntg_hour: str = Field(title="주식 체결시간")
    stck_prpr: str = Field(title="주식 현재가")
    stck_oprc: str = Field(title="주식 시가")
    stck_hgpr: str = Field(title="주식 최고가")
    stck_lwpr: str = Field(title="주식 최저가")
...
class DomesticStockCurrentPriceDailyOvertimePriceItem1(BaseModel):
    ...
    ovtm_untp_tr_pbmn: str = Field(title="시간외 단일가 거래 대금")
    ovtm_untp_mxpr: str = Field(title="시간외 단일가 상한가")
    ovtm_untp_llam: str = Field(title="시간외 단일가 하한가")
    ovtm_untp_oprc: str = Field(title="시간외 단일가 시가2")
    ovtm_untp_hgpr: str = Field(title="시간외 단일가 최고가")
    ovtm_untp_lwpr: str = Field(title="시간외 단일가 최저가")
    ovtm_untp_antc_cnpr: str = Field(title="시간외 단일가 예상 체결가")
    ovtm_untp_antc_cntg_vrss: str = Field(title="시간외 단일가 예상 체결 대비")
    ovtm_untp_antc_cntg_vrss_sign: str = Field(title="시간외 단일가 예상 체결 대비 부호")
    ovtm_untp_antc_cntg_ctrt: str = Field(title="시간외 단일가 예상 체결 대비율")
    ovtm_untp_antc_vol: str = Field(title="시간외 단일가 예상 거래량")
...
class DomesticStockCurrentPriceDailyOvertimePriceItem2(BaseModel):
    ...
    prdy_ctrt: str = Field(title="전일 대비율")
    acml_vol: str = Field(title="누적 거래량")
    ovtm_untp_tr_pbmn: str = Field(title="시간외 단일가 거래대금")
...
class DomesticStockCurrentPriceOvertimeConclusionItem1(BaseModel):
    ...
    ovtm_untp_antc_cnpr: str = Field(title="시간외 단일가 예상 체결가")
    ovtm_untp_antc_cntg_vrss: str = Field(title="시간외 단일가 예상 체결 대비")
    ovtm_untp_antc_cntg_vrss_sign: str = Field(title="시간외 단일가 예상 체결 대비")
    ovtm_untp_antc_cntg_ctrt: str = Field(title="시간외 단일가 예상 체결 대비율")
    ovtm_untp_antc_vol: str = Field(title="시간외 단일가 예상 거래량")
    uplm_sign: str = Field(title="상한 부호")
    lslm_sign: str = Field(title="하한 부호")
...
class DomesticStockOvertimeCurrentPriceItem(BaseModel):
    bstp_kor_isnm: str = Field(title="업종 한글 종목명")
    mang_issu_cls_name: Optional[str] = Field(title="관리 종목 구분 명", default=None)
    ovtm_untp_prpr: str = Field(title="시간외 단일가 현재가")
    ovtm_untp_prdy_vrss: str = Field(title="시간외 단일가 전일 대비")
    ovtm_untp_prdy_vrss_sign: str = Field(title="시간외 단일가 전일 대비 부호")
    ovtm_untp_prdy_ctrt: str = Field(title="시간외 단일가 전일 대비율")
    ...
    crdt_able_yn: str = Field(title="신용 가능 여부")
    new_lstn_cls_name: str = Field(title="신규 상장 구분 명")
    sltr_yn: str = Field(title="정리매매 여부")
    mang_issu_yn: str = Field(title="관리 종목 여부")
    mrkt_warn_cls_code: Optional[str] = Field(title="시장 경고 구분 코드", default=None)
    trht_yn: str = Field(title="거래정지 여부")
    ...
    insn_pbnt_yn: str = Field(title="불성실 공시 여부")
    flng_cls_name: Optional[str] = Field(title="락 구분 이름", default=None)
    rprs_mrkt_kor_name: str = Field(title="대표 시장 한글 명")
    ovtm_vi_cls_code: str = Field(title="시간외단일가VI적용구분코드")
    bidp: str = Field(title="매수호가")
    askp: str = Field(title="매도호가")
...
class DomesticStockOvertimeAskingPriceItem(BaseModel):
    ovtm_untp_last_hour: str = Field(title="시간외 단일가 최종 시간")
    ovtm_untp_askp1: str = Field(title="시간외 단일가 매도호가1")
    ovtm_untp_askp2: str = Field(title="시간외 단일가 매도호가2")
    ovtm_untp_askp3: str = Field(title="시간외 단일가 매도호가3")
    ovtm_untp_askp4: str = Field(title="시간외 단일가 매도호가4")
    ovtm_untp_askp5: str = Field(title="시간외 단일가 매도호가5")
    ovtm_untp_askp6: str = Field(title="시간외 단일가 매도호가6")
    ovtm_untp_askp7: str = Field(title="시간외 단일가 매도호가7")
    ovtm_untp_askp8: str = Field(title="시간외 단일가 매도호가8")
    ovtm_untp_askp9: str = Field(title="시간외 단일가 매도호가9")
    ovtm_untp_askp10: str = Field(title="시간외 단일가 매도호가10")
    ovtm_untp_bidp1: str = Field(title="시간외 단일가 매수호가1")
    ovtm_untp_bidp2: str = Field(title="시간외 단일가 매수호가2")
    ovtm_untp_bidp3: str = Field(title="시간외 단일가 매수호가3")
    ovtm_untp_bidp4: str = Field(title="시간외 단일가 매수호가4")
    ovtm_untp_bidp5: str = Field(title="시간외 단일가 매수호가5")
    ovtm_untp_bidp6: str = Field(title="시간외 단일가 매수호가6")
    ovtm_untp_bidp7: str = Field(title="시간외 단일가 매수호가7")
    ovtm_untp_bidp8: str = Field(title="시간외 단일가 매수호가8")
    ovtm_untp_bidp9: str = Field(title="시간외 단일가 매수호가9")
    ovtm_untp_bidp10: str = Field(title="시간외 단일가 매수호가10")
    ...
    ovtm_untp_askp_icdc7: Optional[str] = Field(title="시간외 단일가 매도호가 증감7", default=None)
    ovtm_untp_askp_icdc8: Optional[str] = Field(title="시간외 단일가 매도호가 증감8", default=None)
    ovtm_untp_askp_icdc9: Optional[str] = Field(title="시간외 단일가 매도호가 증감9", default=None)
    ovtm_untp_askp_icdc10: Optional[str] = Field(title="시간외 단일가 매도호가 증감10", default=None)
    ovtm_untp_bidp_icdc1: str = Field(title="시간외 단일가 매수호가 증감1")
    ovtm_untp_bidp_icdc2: str = Field(title="시간외 단일가 매수호가 증감2")
    ovtm_untp_bidp_icdc3: str = Field(title="시간외 단일가 매수호가 증감3")
    ovtm_untp_bidp_icdc4: Optional[str] = Field(title="시간외 단일가 매수호가 증감4", default=None)
    ovtm_untp_bidp_icdc5: Optional[str] = Field(title="시간외 단일가 매수호가 증감5", default=None)
    ovtm_untp_bidp_icdc6: Optional[str] = Field(title="시간외 단일가 매수호가 증감6", default=None)
    ovtm_untp_bidp_icdc7: Optional[str] = Field(title="시간외 단일가 매수호가 증감7", default=None)
    ovtm_untp_bidp_icdc8: Optional[str] = Field(title="시간외 단일가 매수호가 증감8", default=None)
    ovtm_untp_bidp_icdc9: Optional[str] = Field(title="시간외 단일가 매수호가 증감9", default=None)
    ovtm_untp_bidp_icdc10: Optional[str] = Field(title="시간외 단일가 매수호가 증감10", default=None)
    ovtm_untp_askp_rsqn1: str = Field(title="시간외 단일가 매도호가 잔량1")
    ovtm_untp_askp_rsqn2: str = Field(title="시간외 단일가 매도호가 잔량2")
    ovtm_untp_askp_rsqn3: str = Field(title="시간외 단일가 매도호가 잔량3")
    ovtm_untp_askp_rsqn4: str = Field(title="시간외 단일가 매도호가 잔량4")
    ovtm_untp_askp_rsqn5: str = Field(title="시간외 단일가 매도호가 잔량5")
    ovtm_untp_askp_rsqn6: str = Field(title="시간외 단일가 매도호가 잔량6")
    ovtm_untp_askp_rsqn7: str = Field(title="시간외 단일가 매도호가 잔량7")
    ovtm_untp_askp_rsqn8: str = Field(title="시간외 단일가 매도호가 잔량8")
    ovtm_untp_askp_rsqn9: str = Field(title="시간외 단일가 매도호가 잔량9")
    ovtm_untp_askp_rsqn10: str = Field(title="시간외 단일가 매도호가 잔량10")
    ovtm_untp_bidp_rsqn1: str = Field(title="시간외 단일가 매수호가 잔량1")
    ovtm_untp_bidp_rsqn2: str = Field(title="시간외 단일가 매수호가 잔량2")
    ovtm_untp_bidp_rsqn3: str = Field(title="시간외 단일가 매수호가 잔량3")
    ovtm_untp_bidp_rsqn4: str = Field(title="시간외 단일가 매수호가 잔량4")
    ovtm_untp_bidp_rsqn5: str = Field(title="시간외 단일가 매수호가 잔량5")
    ovtm_untp_bidp_rsqn6: str = Field(title="시간외 단일가 매수호가 잔량6")
    ovtm_untp_bidp_rsqn7: str = Field(title="시간외 단일가 매수호가 잔량7")
    ovtm_untp_bidp_rsqn8: str = Field(title="시간외 단일가 매수호가 잔량8")
    ovtm_untp_bidp_rsqn9: str = Field(title="시간외 단일가 매수호가 잔량9")
    ovtm_untp_bidp_rsqn10: str = Field(title="시간외 단일가 매수호가 잔량10")
    ovtm_untp_total_askp_rsqn: str = Field(title="시간외 단일가 총 매도호가 잔량")
    ovtm_untp_total_bidp_rsqn: str = Field(title="시간외 단일가 총 매수호가 잔량")
    ovtm_untp_total_askp_rsqn_icdc: str = Field(title="시간외 단일가 총 매도호가 잔량 증감")
    ovtm_untp_total_bidp_rsqn_icdc: str = Field(title="시간외 단일가 총 매수호가 잔량 증감")
    ovtm_untp_ntby_bidp_rsqn: str = Field(title="시간외 단일가 순매수 호가 잔량")
    total_askp_rsqn: str = Field(title="총 매도호가 잔량")
    total_bidp_rsqn: str = Field(title="총 매수호가 잔량")
    total_askp_rsqn_icdc: str = Field(title="총 매도호가 잔량 증감")
    total_bidp_rsqn_icdc: str = Field(title="총 매수호가 잔량 증감")
...
class DomesticStockClosingExpectedPriceItem(BaseModel):
    ...
    prdy_vrss_sign: str = Field(title="전일 대비 부호")
    prdy_ctrt: str = Field(title="전일 대비율")
    sdpr_vrss_prpr: str = Field(title="기준가 대비 현재가")
    sdpr_vrss_prpr_rate: str = Field(title="기준가 대비 현재가 비율")
    cntg_vol: str = Field(title="체결 거래량")
...
class DomesticEtfEtnCurrentPriceItem(BaseModel):
    ...
    stck_lwpr: str = Field(title="주식 최저가")
    prdy_clpr_vrss_lwpr_rate: str = Field(title="전일 종가 대비 최저가 비율")
    prdy_last_nav: str = Field(title="전일 최종 NAV")
    nav: str = Field(title="NAV")
    nav_prdy_vrss: str = Field(title="NAV 전일 대비")
    nav_prdy_vrss_sign: str = Field(title="NAV 전일 대비 부호")
    nav_prdy_ctrt: str = Field(title="NAV 전일 대비율")
    ...
    etf_frcr_ntas_ttam: str = Field(title="ETF 외화 순자산 총액")
    frgn_limt_rate: str = Field(title="외국인 한도 비율")
    frgn_oder_able_qty: str = Field(title="외국인 주문 가능 수량")
    etf_cu_unit_scrt_cnt: str = Field(title="ETF CU 단위 증권 수")
    etf_cnfg_issu_cnt: str = Field(title="ETF 구성 종목 수")
    etf_dvdn_cycl: str = Field(title="ETF 배당 주기")
    crcd: str = Field(title="통화 코드")
    etf_crcl_ntas_ttam: str = Field(title="ETF 유통 순자산 총액")
    etf_frcr_crcl_ntas_ttam: str = Field(title="ETF 외화 유통 순자산 총액")
    etf_frcr_last_ntas_wrth_val: str = Field(title="ETF 외화 최종 순자산 가치 값")
    lp_oder_able_cls_code: str = Field(title="LP 주문 가능 구분 코드")
    stck_dryy_hgpr: str = Field(title="주식 연중 최고가")
    dryy_hgpr_vrss_prpr_rate: str = Field(title="연중 최고가 대비 현재가 비율")
    dryy_hgpr_date: str = Field(title="연중 최고가 일자")
    stck_dryy_lwpr: str = Field(title="주식 연중 최저가")
    ...
    lstn_stcn: str = Field(title="상장 주수")
    frgn_hldn_qty: str = Field(title="외국인 보유 수량")
    frgn_hldn_qty_rate: str = Field(title="외국인 보유 수량 비율")
    etf_trc_ert_mltp: str = Field(title="ETF 추적 수익률 배수")
    dprt: str = Field(title="괴리율")
    mbcr_name: str = Field(title="회원사 명")
    stck_lstn_date: str = Field(title="주식 상장 일자")
    mtrt_date: str = Field(title="만기 일자")
    shrg_type_code: str = Field(title="분배금형태코드")
    lp_hldn_rate: str = Field(title="LP 보유 비율")
    etf_trgt_nmix_bstp_code: str = Field(title="ETF대상지수업종코드")
    etf_div_name: str = Field(title="ETF 분류 명")
    etf_rprs_bstp_kor_isnm: str = Field(title="ETF 대표 업종 한글 종목명")
    lp_hldn_vol: str = Field(title="ETN LP 보유량")
...
class DomesticEtfComponentStockPriceItem1(BaseModel):
    stck_prpr: str = Field(title="매매 일자")
    prdy_vrss: str = Field(title="주식 현재가")
    prdy_vrss_sign: str = Field(title="전일 대비 부호")
    prdy_ctrt: str = Field(title="전일 대비")
    etf_cnfg_issu_avls: str = Field(title="전일 대비율")
    nav: str = Field(title="누적 거래량")
    nav_prdy_vrss_sign: str = Field(title="결제 일자")
    nav_prdy_vrss: str = Field(title="전체 융자 신규 주수")
    nav_prdy_ctrt: str = Field(title="전체 융자 상환 주수")
    etf_ntas_ttam: str = Field(title="전체 융자 잔고 주수")
    prdy_clpr_nav: str = Field(title="전체 융자 신규 금액")
    oprc_nav: str = Field(title="전체 융자 상환 금액")
    hprc_nav: str = Field(title="전체 융자 잔고 금액")
    lprc_nav: str = Field(title="전체 융자 잔고 비율")
    etf_cu_unit_scrt_cnt: str = Field(title="전체 융자 공여율")
    etf_cnfg_issu_cnt: str = Field(title="전체 대주 신규 주수")
...
class DomesticEtfComponentStockPriceItem2(BaseModel):
    ...
    acml_vol: str = Field(title="누적 거래량")
    acml_tr_pbmn: str = Field(title="누적 거래 대금")
    tday_rsfl_rate: str = Field(title="당일 등락 비율")
    prdy_vrss_vol: str = Field(title="전일 대비 거래량")
    tr_pbmn_tnrt: str = Field(title="거래대금회전율")
    hts_avls: str = Field(title="HTS 시가총액")
    etf_cnfg_issu_avls: str = Field(title="ETF구성종목시가총액")
    etf_cnfg_issu_rlim: str = Field(title="ETF구성종목비중")
    etf_cu_unit_scrt_cnt: str = Field(title="ETF CU 단위 증권 수")
    etf_vltn_amt: str = Field(title="ETF구성종목내평가금액")
...
class DomesticEtfNavComparisonTrendItem2(BaseModel):
    ...
    nav_prdy_vrss: str = Field(title="NAV 전일 대비")
    nav_prdy_ctrt: str = Field(title="NAV 전일 대비율")
    prdy_clpr_nav: str = Field(title="NAV전일종가")
    oprc_nav: str = Field(title="NAV시가")
    hprc_nav: str = Field(title="NAV고가")
    lprc_nav: str = Field(title="NAV저가")
...
class DomesticEtfNavComparisonDailyTrendItem(BaseModel):
    stck_bsop_date: str = Field(alias="stck_bsop_date", title="주식 영업 일자")
    stck_clpr: str = Field(alias="stck_clpr", title="주식 종가")
    prdy_vrss: str = Field(alias="prdy_vrss", title="전일 대비")
    prdy_vrss_sign: str = Field(alias="prdy_vrss_sign", title="전일 대비 부호")
    prdy_ctrt: str = Field(alias="prdy_ctrt", title="전일 대비율")
    acml_vol: str = Field(alias="acml_vol", title="누적 거래량")
    cntg_vol: str = Field(alias="cntg_vol", title="체결 거래량")
    dprt: str = Field(alias="dprt", title="괴리율")
    nav_vrss_prpr: str = Field(alias="nav_vrss_prpr", title="NAV 대비 현재가")
    nav: str = Field(alias="nav", title="NAV")
    nav_prdy_vrss_sign: str = Field(alias="nav_prdy_vrss_sign", title="NAV 전일 대비 부호")
    nav_prdy_vrss: str = Field(alias="nav_prdy_vrss", title="NAV 전일 대비")
    nav_prdy_ctrt: str = Field(alias="nav_prdy_ctrt", title="NAV 전일 대비율")
