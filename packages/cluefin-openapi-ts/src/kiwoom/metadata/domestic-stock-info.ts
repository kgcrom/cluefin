...
export type DomesticStockInfoMethodName =
  | 'getStockInfo'
  | 'getStockTradingMember'
  | 'getExecution'
  | 'getMarginTradingTrend'
  | 'getDailyTradingDetails'
  | 'getNewHighLowPrice'
  | 'getUpperLowerLimitPrice'
  | 'getHighLowPriceApproach'
  | 'getPriceVolatility'
  | 'getTradingVolumeRenewal'
  ...
  | 'getDailyPreviousDayExecutionVolume'
  | 'getDailyTradingItemsByInvestor'
  | 'getInstitutionalInvestorByStock'
  | 'getTotalInstitutionalInvestorByStock'
  | 'getDailyPreviousDayConclusion'
  | 'getInterestStockInfo'
  | 'getStockInfoSummary'
  | 'getStockInfoV1'
  | 'getIndustryCode'
  | 'getMemberCompany'
  | 'getTop50ProgramNetBuy'
  | 'getProgramTradingStatusByStock';
