...
import {
  type OverseasStockInquiryMethodName,
  overseasStockInquiryEndpoints,
} from './metadata/overseas-stock-inquiry.js';
import type { OverseasStockInquiryResponseMap } from './schemas/overseas-stock-inquiry.js';
