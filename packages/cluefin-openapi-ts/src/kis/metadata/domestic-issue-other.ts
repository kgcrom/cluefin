...
export type DomesticIssueOtherMethodName =
  | 'getSectorCurrentIndex'
  | 'getSectorDailyIndex'
  | 'getSectorTimeIndexSecond'
  | 'getSectorTimeIndexMinute'
  | 'getSectorMinuteInquiry'
  | 'getSectorPeriodQuote'
  | 'getSectorAllQuoteByCategory'
  | 'getExpectedIndexTrend'
  | 'getExpectedIndexAll'
  | 'getVolatilityInterruptionStatus'
  | 'getInterestRateSummary'
  | 'getMarketAnnouncementSchedule'
  | 'getHolidayInquiry'
  | 'getFuturesBusinessDayInquiry';
