...
export const domesticMarketAnalysisEndpoints: KisEndpointDefinition[] = [
  ...
  },
  {
    ...
    params: [
      { name: 'fidCondMrktDivCode1', required: true },
      { name: 'fidInputIscd1', required: true },
      { name: 'fidCondMrktDivCode2', required: true },
      { name: 'fidInputIscd2', required: true },
      { name: 'fidCondMrktDivCode3', required: true },
      { name: 'fidInputIscd3', required: true },
      { name: 'fidCondMrktDivCode4', required: true },
      { name: 'fidInputIscd4', required: true },
      { name: 'fidCondMrktDivCode5', required: true },
      { name: 'fidInputIscd5', required: true },
      { name: 'fidCondMrktDivCode6', required: true },
      { name: 'fidInputIscd6', required: true },
      { name: 'fidCondMrktDivCode7', required: true },
      { name: 'fidInputIscd7', required: true },
      { name: 'fidCondMrktDivCode8', required: true },
      { name: 'fidInputIscd8', required: true },
      { name: 'fidCondMrktDivCode9', required: true },
      { name: 'fidInputIscd9', required: true },
      { name: 'fidCondMrktDivCode10', required: true },
      { name: 'fidInputIscd10', required: true },
      { name: 'fidCondMrktDivCode11', required: true },
      { name: 'fidInputIscd11', required: true },
      { name: 'fidCondMrktDivCode12', required: true },
      { name: 'fidInputIscd12', required: true },
      { name: 'fidCondMrktDivCode13', required: true },
      { name: 'fidInputIscd13', required: true },
      { name: 'fidCondMrktDivCode14', required: true },
      { name: 'fidInputIscd14', required: true },
      { name: 'fidCondMrktDivCode15', required: true },
      { name: 'fidInputIscd15', required: true },
      { name: 'fidCondMrktDivCode16', required: true },
      { name: 'fidInputIscd16', required: true },
      { name: 'fidCondMrktDivCode17', required: true },
      { name: 'fidInputIscd17', required: true },
      { name: 'fidCondMrktDivCode18', required: true },
      { name: 'fidInputIscd18', required: true },
      { name: 'fidCondMrktDivCode19', required: true },
      { name: 'fidInputIscd19', required: true },
      { name: 'fidCondMrktDivCode20', required: true },
      { name: 'fidInputIscd20', required: true },
      { name: 'fidCondMrktDivCode21', required: true },
      { name: 'fidInputIscd21', required: true },
      { name: 'fidCondMrktDivCode22', required: true },
      { name: 'fidInputIscd22', required: true },
      { name: 'fidCondMrktDivCode23', required: true },
      { name: 'fidInputIscd23', required: true },
      { name: 'fidCondMrktDivCode24', required: true },
      { name: 'fidInputIscd24', required: true },
      { name: 'fidCondMrktDivCode25', required: true },
      { name: 'fidInputIscd25', required: true },
      { name: 'fidCondMrktDivCode26', required: true },
      { name: 'fidInputIscd26', required: true },
      { name: 'fidCondMrktDivCode27', required: true },
      { name: 'fidInputIscd27', required: true },
      { name: 'fidCondMrktDivCode28', required: true },
      { name: 'fidInputIscd28', required: true },
      { name: 'fidCondMrktDivCode29', required: true },
      { name: 'fidInputIscd29', required: true },
      { name: 'fidCondMrktDivCode30', required: true },
      { name: 'fidInputIscd30', required: true },
    ],
  },
  {
