...
export type DomesticBasicQuoteMethodName =
  | 'getStockCurrentPrice'
  | 'getStockCurrentPrice2'
  | 'getStockCurrentPriceConclusion'
  | 'getStockCurrentPriceDaily'
  | 'getStockCurrentPriceAskingExpectedConclusion'
  | 'getStockCurrentPriceInvestor'
  | 'getStockCurrentPriceMember'
  | 'getStockPeriodQuote'
  | 'getStockTodayMinuteChart'
  | 'getStockDailyMinuteChart'
  | 'getStockCurrentPriceTimeItemConclusion'
  | 'getStockCurrentPriceDailyOvertimePrice'
  | 'getStockCurrentPriceOvertimeConclusion'
  | 'getStockOvertimeCurrentPrice'
  | 'getStockOvertimeAskingPrice'
  | 'getStockClosingExpectedPrice'
  | 'getEtfetnCurrentPrice'
  | 'getEtfComponentStockPrice'
  | 'getEtfNavComparisonTrend'
  | 'getEtfNavComparisonDailyTrend'
  | 'getEtfNavComparisonTimeTrend';
