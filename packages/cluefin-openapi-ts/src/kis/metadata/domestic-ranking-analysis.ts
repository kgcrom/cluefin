...
export const domesticRankingAnalysisEndpoints: KisEndpointDefinition[] = [
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/hoga-quantity-rank',
    trId: 'FHPST01720000',
    requestMap: {
      fid_vol_cnt: 'fidVolCnt',
      fid_cond_mrkt_div_code: 'fidCondMrktDivCode',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/profitability-indicator-rank',
    trId: 'FHPST01730000',
    requestMap: {
      fid_cond_mrkt_div_code: 'fidCondMrktDivCode',
      fid_trgt_cls_code: 'fidTrgtClsCode',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/market-cap-top',
    trId: 'FHPST01740000',
    requestMap: {
      fid_input_price_2: 'fidInputPrice2',
      fid_cond_mrkt_div_code: 'fidCondMrktDivCode',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/finance-ratio-rank',
    trId: 'FHPST01750000',
    requestMap: {
      fid_trgt_cls_code: 'fidTrgtClsCode',
      fid_cond_mrkt_div_code: 'fidCondMrktDivCode',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/time-hoga-rank',
    trId: 'FHPST01760000',
    requestMap: {
      fid_input_price_1: 'fidInputPrice1',
      fid_cond_mrkt_div_code: 'fidCondMrktDivCode',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/preferred-stock-ratio-top',
    trId: 'FHPST01770000',
    requestMap: {
      fid_vol_cnt: 'fidVolCnt',
      fid_cond_mrkt_div_code: 'fidCondMrktDivCode',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/disparity-index-rank',
    trId: 'FHPST01780000',
    requestMap: {
      fid_input_price_2: 'fidInputPrice2',
      fid_cond_mrkt_div_code: 'fidCondMrktDivCode',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/market-price-rank',
    trId: 'FHPST01790000',
    requestMap: {
      fid_trgt_cls_code: 'fidTrgtClsCode',
      fid_cond_mrkt_div_code: 'fidCondMrktDivCode',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/execution-strength-top',
    trId: 'FHPST01680000',
    requestMap: {
      fid_trgt_exls_cls_code: 'fidTrgtExlsClsCode',
      fid_cond_mrkt_div_code: 'fidCondMrktDivCode',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/ranking/watchlist-registration-top',
    trId: 'FHPST01800000',
    requestMap: {
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/expected-execution-rise-decline-top',
    trId: 'FHPST01820000',
    requestMap: {
      fid_rank_sort_cls_code: 'fidRankSortClsCode',
      fid_cond_mrkt_div_code: 'fidCondMrktDivCode',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/proprietary-trading-top',
    trId: 'FHPST01860000',
    requestMap: {
      fid_trgt_exls_cls_code: 'fidTrgtExlsClsCode',
      fid_cond_mrkt_div_code: 'fidCondMrktDivCode',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/new-high-low-approaching-top',
    trId: 'FHPST01870000',
    requestMap: {
      fid_aply_rang_vol: 'fidAplyRangVol',
      fid_cond_mrkt_div_code: 'fidCondMrktDivCode',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/short-selling-top',
    trId: 'FHPST04820000',
    requestMap: {
      FID_APLY_RANG_VOL: 'fidAplyRangVol',
      FID_COND_MRKT_DIV_CODE: 'fidCondMrktDivCode',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/after-hours-fluctuation-rank',
    trId: 'FHPST02340000',
    requestMap: {
      FID_COND_MRKT_DIV_CODE: 'fidCondMrktDivCode',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/after-hours-volume-rank',
    trId: 'FHPST02350000',
    requestMap: {
      FID_COND_MRKT_DIV_CODE: 'fidCondMrktDivCode',
      FID_COND_SCR_DIV_CODE: 'fidCondScrDivCode',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/credit-balance-top',
    trId: 'HHKST17010000',
    requestMap: {
      FID_COND_SCR_DIV_CODE: 'fidCondScrDivCode',
      FID_INPUT_ISCD: 'fidInputIscd',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/dividend-yield-top',
    trId: 'HHKDB13470100',
    requestMap: {
      CTS_AREA: 'ctsArea',
      GB1: 'gb1',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/uapi/domestic-stock/v1/quotations/large-execution-count-top',
    trId: 'HHKST1909000C0',
    requestMap: {
      fid_aply_rang_prc_2: 'fidAplyRangPrc2',
      fid_cond_mrkt_div_code: 'fidCondMrktDivCode',
