...
export type DomesticStockInfoMethodName =
  | 'getProductBasicInfo'
  | 'getStockBasicInfo'
  | 'getBalanceSheet'
  | 'getIncomeStatement'
  ...
  | 'getStabilityRatio'
  | 'getGrowthRatio'
  | 'getMarginTradableStocks'
  | 'getKsdDividendDecision'
  | 'getKsdStockDividendDecision'
  | 'getKsdMergerSplitDecision'
  | 'getKsdParValueChangeDecision'
  | 'getKsdCapitalReductionSchedule'
  | 'getKsdListingInfoSchedule'
  | 'getKsdIpoSubscriptionSchedule'
  | 'getKsdForfeitedShareSchedule'
  | 'getKsdDepositSchedule'
  | 'getKsdPaidInCapitalIncreaseSchedule'
  | 'getKsdStockDividendSchedule'
  | 'getKsdShareholderMeetingSchedule'
  | 'getEstimatedEarnings'
  | 'getStockLoanableList'
  | 'getInvestmentOpinion'
  | 'getInvestmentOpinionByBrokerage';
